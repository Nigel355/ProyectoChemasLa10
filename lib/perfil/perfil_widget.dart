                                ...
                                child: StreamBuilder<List<CarritoRecord>>(
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    return InkWell(
                                      ...
                                      onTap: () async {
                                        context
                                            .pushNamed(CarritoWidget.routeName);
                                      },
                                      child: Icon(
                      ...
                      child: Row(
                        ...
                        children: [
                          Container(
                            ...
                            height: 100.0,
                            decoration: BoxDecoration(
                              color: Color(0xB7E0B3E5),
                              shape: BoxShape.circle,
                            ),
                            child: Icon(
                              Icons.favorite_border,
                              color: Color(0xFFC455D6),
                              size: 40.0,
                            ),
                          ),
                          Text(
                      ...
                      child: Row(
                        ...
                        children: [
                          Container(
                            ...
                            height: 100.0,
                            decoration: BoxDecoration(
                              color: Color(0xB7B3DAE5),
                              shape: BoxShape.circle,
                            ),
                            child: Icon(
                              Icons.credit_card,
                              color: Color(0xFF5593D6),
                              size: 40.0,
                            ),
                          ),
                          Text(
                        ...
                        builder: (context) => Container(
                          ...
                          child: Visibility(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                context
                                    .pushNamed(DashboardAdminWidget.routeName);
                              },
                              child: Row(
                                mainAxisSize: MainAxisSize.max,
                                children: [
