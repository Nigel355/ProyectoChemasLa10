...
import '/components/sinpe_widget.dart';
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        valueOrDefault<String>(
                                          carritoCarritoRecord?.contadorItems
                                              .toString(),
                                          '0',
                                        ),
                              ...
                              Builder(
                                builder: (context) {
                                  final itemsSeleccionados =
                                      carritoCarritoRecord?.camisaSeleccionada
                                              .toList() ??
                                          [];
                                        ...
                                        children: [
                                          Padding(
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                StreamBuilder<
                                                    CamisasSeleccionadasRecord>(
                                                  stream: CamisasSeleccionadasRecord
                                                      .getDocument(
                                                  ...
                                                  builder: (context, snapshot) {
                                                    ...
                                                    final productContainerCamisasSeleccionadasRecord =
                                                        snapshot.data!;
                                                            ...
                                                            children: [
                                                              Padding(
                                                                ...
                                                                child:
                                                                  ...
                                                                  child: Image
                                                                      .network(
                                                                    productContainerCamisasSeleccionadasRecord
                                                                        .imagen,
                                                                    width: 74.0,
                                                                    height:
                                                                        74.0,
                                                                          ...
                                                                          onTap:
                                                                            ...
                                                                            if (confirmDialogResponse) {
                                                                              await carritoCarritoRecord!.reference.update({
                                                                                ...mapToFirestore(
                                                                                  {
                                                                                    'contadorItems': FieldValue.increment(-(productContainerCamisasSeleccionadasRecord.cantidad)),
                                                                                    'monto': FieldValue.increment(-(productContainerCamisasSeleccionadasRecord.subtotal)),
                                                                                    'camisaSeleccionada': FieldValue.arrayRemove([
                                                                                      productContainerCamisasSeleccionadasRecord.reference
                                                                                    ]),
                                                                                  },
                                                                                ),
                                                                              });
                                                                              await productContainerCamisasSeleccionadasRecord.reference.delete();
                                                                            }
                                                                            if (carritoCarritoRecord!.contadorItems <=
                                                                                1) {
                                                                  ...
                                                                  Padding(
                                                                    padding: EdgeInsetsDirectional
                                                                        .fromSTEB(
                                                                            ...
                                                                            4.0),
                                                                    child: Text(
                                                                      'Descripcion: ${productContainerCamisasSeleccionadasRecord.descripcion}',
                                                                      maxLines:
                                                                          2,
                                                                  ...
                                                                  Padding(
                                                                    ...
                                                                    child: Row(
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Text(
                                                                          formatNumber(
                                                                            productContainerCamisasSeleccionadasRecord.subtotal,
                                                                            formatType:
                                                                                FormatType.decimal,
                                                                            decimalType:
                                                ...
                                                Align(
                                                  alignment:
                                                      AlignmentDirectional(
                                                          -1.0, 0.0),
                                                  child: Text(
                                                    'Mensajeria privada: 1-2 dias habiles (₡ 3.500)',
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                                        .bodyMedium
                                                        .override(
                                                ...
                                                Align(
                                                  alignment:
                                                      AlignmentDirectional(
                                                          -1.0, 0.0),
                                                  child: Text(
                                                    'Correos CR: 2-3 dias habiles (₡ 2.500)',
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                                        .bodyMedium
                                                        .override(
                                  ...
                                  onPressed: () async {
                                    ...
                                    await ordenRecordReference.set({
                                      ...createOrdenRecordData(
                                        ...
                                        estado: 'pendiente',
                                        iva: functions
                                            .iva(carritoCarritoRecord.monto),
                                        fechaCreacion: getCurrentTimestamp,
                                        user: currentUserReference,
                                        carrito:
                                            carritoCarritoRecord.reference,
                                        costoEnvio: _model.dropDownValue ==
                                                'Mensajeria Privada'
                                            ? 3500.0
                                            : 2500.0,
                                        metodoPago: _model.choiceChipsValue,
                                        tipoEnvio: _model.dropDownValue,
                                        direccion: _model.textController.text,
                                      ),
                                      ...mapToFirestore(
                                        {
                                          'camisasSeleccionadas':
                                              carritoCarritoRecord
                                                  .camisaSeleccionada,
                                        },
                                      ),
                                    ...
                                    _model.orden =
                                        OrdenRecord.getDocumentFromData({
                                      ...createOrdenRecordData(
                                        nombre: currentUserDisplayName,
                                        monto: functions.totalOrden(
                                            carritoCarritoRecord.monto,
                                    ...
                                    await EnviosRecord.collection
                                        .doc()
                                        .set(createEnviosRecordData(
                                          orden: _model.orden?.reference,
                                          usuario: currentUserReference,
                                          direccion: _model.textController.text,
                                          tipo: _model.dropDownValue,
                                          costo: _model.dropDownValue ==
                                                  'Mensajeria Privada'
                                              ? 3500.0
                                              : 2500.0,
                                        ));
                                    ...
                                    await PagosRecord.collection
                                        ...
                                        .set(createPagosRecordData(
                                          orden: _model.orden?.reference,
                                          usuario: currentUserReference,
                                          metodo: _model.choiceChipsValue,
                                          monto: functions.totalOrden(
                                              carritoCarritoRecord.monto,
                                              _model.dropDownValue ==
                                                      'Mensajeria Privada'
                                    ...
                                    await currentUserReference!.update({
                                      ...mapToFirestore(
                                        {
                                          'listaOrden': FieldValue.arrayUnion(
                                    ...
                                    context.pushNamed(
                                      OrdenConfirmadaWidget.routeName,
                                      queryParameters: {
