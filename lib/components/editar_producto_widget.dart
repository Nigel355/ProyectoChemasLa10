...
class EditarProductoWidget extends StatefulWidget {
  const EditarProductoWidget({
    super.key,
    required this.camisas,
  });

  final DocumentReference? camisas;
...
class _EditarProductoWidgetState extends State<EditarProductoWidget> {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: StreamBuilder<CamisasRecord>(
        stream: CamisasRecord.getDocument(widget.camisas!),
        builder: (context, snapshot) {
          ...
          final columnCamisasRecord = snapshot.data!;
                                ...
                                children: [
                                  ...
                                  TextFormField(
                                    controller: _model.textController1 ??=
                                      ...
                                      text: columnCamisasRecord.nombre,
                                    ),
                                ...
                                children: [
                                  ...
                                  TextFormField(
                                    controller: _model.textController2 ??=
                                        TextEditingController(
                                      text: columnCamisasRecord.descripcion,
                                    ),
                                      ...
                                      children: [
                                        ...
                                        TextFormField(
                                          controller: _model.textController3 ??=
                                              TextEditingController(
                                            text: columnCamisasRecord.precio
                                                .toString(),
                                          ),
                                ...
                                children: [
                                  ...
                                  Switch(
                                    value: _model.switchValue ??=
                                        columnCamisasRecord.disponible,
              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      await widget.camisas!.update(createCamisasRecordData(
                        nombre: _model.textController1.text,
                        descripcion: _model.textController2.text,
                        precio: double.tryParse(_model.textController3.text),
